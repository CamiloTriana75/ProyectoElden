    ...
    <div className="p-4 sm:p-8 max-w-full md:max-w-3xl lg:max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0 mb-6 sm:mb-8">
        ...
        <div className="bg-gray-800/70 backdrop-blur-sm rounded-xl p-2 sm:p-4">
          <div className="text-green-300 text-xs sm:text-sm mb-1 sm:mb-2">
            Filtros
          </div>
          <div className="flex flex-col gap-1 sm:gap-2">
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="all-status" className="text-green-200 text-sm">
                Todas
              </label>
            </div>
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="pending" className="text-yellow-200 text-sm">
                Pendientes
              </label>
            </div>
            <div className="flex items-center gap-2">
              <input
                ...
                className="text-green-500"
              />
              <label htmlFor="confirmed" className="text-green-200 text-sm">
                Confirmadas
              </label>
            </div>
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="cancelled" className="text-red-200 text-sm">
                Canceladas
              </label>
            </div>
          </div>
      ...
      {viewMode === "calendar" ? (
        <CalendarView
          isAdminOrEmployee={isAdmin || isEmployee}
          onMakeReservation={() => onSectionChange?.("canchas")}
        />
      ) : (
            ...
            <table className="w-full text-xs sm:text-sm bg-transparent">
              <thead className="bg-gray-800/80">
                <tr>
                  ...
                  <th className="px-6 py-4 text-right text-white font-medium">
                    Acción
                  </th>
                </tr>
              </thead>
      ...
      {!(isAdmin || isEmployee) && filteredReservations.length > 0 && (
        <>
          <div className="flex justify-center mt-8">
            <div className="text-red-400 text-sm font-medium"></div>
          </div>
